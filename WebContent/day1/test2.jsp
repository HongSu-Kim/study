...
<body>
	<form action="" method="post" name="myForm">
		...
		<input type="text" name="tel2" maxlength="4" onkeypress="onlyNum();"/>
		-
		<input type="text" name="tel3" maxlength="4" onkeypress="onlyNum();"/><br/>
		취미:<br/>
		...
		<input type="button" value="취소" onclick="location='<%=cp%>/index.jsp';"/>
			<!-- onclick="javascript:location.href='http://localhost:8080/study/index.jsp';"/> -->
