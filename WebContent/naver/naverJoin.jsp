...
<body>
	<form action="<%=cp%>/naver/naverTest.jsp" method="get" name="myForm">
		<div align="center" style="width: 460px; padding-top: 60px; margin: auto;">
			...
			<div class="row">
				<h4 class="head"><label for="tel2">휴대전화</label></h4>
				...
				<p>
					<span class="box tel2Box" id="tel2Box" onclick="inputFocus('tel2')">
						<input type="text" class="tel2Input" id="tel2" name="tel" align="left" style="width: 320px;" maxlength="11" onblur="check(this.id)" onkeyup="infoNone(this.id)" onfocus="inputHighlight(this.id)">
						<input type="text" class="relativeInput" id="tel2Info" value="전화번호 입력" readonly="readonly">
					</span>
				...
				<p class="msg">
					<span id="tel2MsgNull" style="display: none;">필수정보입니다.</span>
					<span id="tel2MsgErr" style="display: none;">형식에 맞지 않는 번호입니다.</span>
			...
			<div align="center" style="margin-top: 30px;">
				<a href="javascript:join();" class="button" style="width: 462px; font-size: 20px; margin-bottom: 30px;"><b>가입하기</b></a>
			</div>
